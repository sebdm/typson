            ...
            //maps
                ...
                if (members[0].returnTypeAnnotation) {
                    ...
                    if (!variableType) {
                        ...
                        handlePropertyDeclaration(variable.typeExpr.term.members.members[0].returnTypeAnnotation.term, property.additionalProperties, definitions, refPath);
                        variableType = "any";
                    }
                }
                // Object (inline declaration)
                    ...
                    _.defaults(property, defaultProperties);
                    property.properties = {};
                    handlePropertyDeclaration(variable.typeExpr.term, property, definitions, refPath);
                    variableType = "any";
                }
            }
            //other
